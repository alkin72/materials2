...
class Contragents(models.Model):
    ...
    e_mail = models.EmailField(db_column='e-mail', max_length=255, blank=True, null=True)  # Field renamed to remove unsuitable characters.
    note = models.CharField(max_length=255, blank=True, null=True)
...
class ReceiptDetail(models.Model):
    ...
    receipt = models.ForeignKey(Receipt, models.DO_NOTHING)
    materials = models.ForeignKey(Materials, models.DO_NOTHING, verbose_name='')
    value = models.DecimalField(verbose_name='', max_digits=4, decimal_places=2)
